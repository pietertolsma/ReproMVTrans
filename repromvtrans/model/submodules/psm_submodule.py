...
from repromvtrans.utils.layer_operations import convbn
...
class PSMFeatureExtraction(nn.Module):
    def __init__(self):
        super(PSMFeatureExtraction, self).__init__()
        self.inplanes = 32
        ...
        self.layer1 = self._make_layer(
            block=BasicBlock, planes=32, blocks=3, stride=1, pad=1, dilation=1
        )
        self.layer2 = self._make_layer(
            block=BasicBlock, planes=64, blocks=16, stride=2, pad=1, dilation=1
        )
        ...
        self.branch1 = nn.Sequential(
            ...
            convbn(
                in_planes=128, out_planes=32, kernel_size=1, stride=1, pad=0, dilation=1
            ),
            nn.ReLU(inplace=True),
        )
